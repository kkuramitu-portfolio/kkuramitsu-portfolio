  ...
  return (
    <div>
      ...
      <details className="mb-6 border-t border-slate-100 pt-4 group">
        <summary data-accordion-name="Go Demo: 技術的なポイント" className="list-none [&::-webkit-details-marker]:hidden cursor-pointer w-full text-left font-bold text-slate-700 p-2 hover:bg-slate-50 rounded transition-colors flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 select-none">
